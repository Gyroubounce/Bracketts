...
function genererToursSession3($joueurs, $matchs_joues, $lastIds) {
    $tours = [];
...
$tours = genererToursSession3($joueurs, $matchs_joues, $lastIds);
...
$_SESSION['tours_session3'] = $tours;

// Rediriger vers la page eliminatoire_session2.php
header("Location: /bracketts/views_tour/T3_eliminatoire.php");
exit;
