...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($joueur1_wins == 3 || $joueur2_wins == 3) {
        ...
        $check_existing_query = $conn->prepare("SELECT id FROM score_impairs WHERE id_match = ? AND id_tournoi = ?");
        ...
        if ($exists) {
            ...
            if (!$update_scores_query->execute()) {
                ...
                header('Location: /bracketts/views_tour/T3_résultat.php');
                exit;
            }
