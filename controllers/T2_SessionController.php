...
function genererToursSession2($joueurs, $matchs_joues, $lastIds) {
    $tours = [];
...
$tours = genererToursSession2($joueurs, $matchs_joues, $lastIds);
...
$_SESSION['tours_session2'] = $tours;

// Rediriger vers la page eliminatoire_session2.php
header("Location: /bracketts/views_tour/T2_eliminatoire.php");
exit;
