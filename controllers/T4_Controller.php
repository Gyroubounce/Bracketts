...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($joueur1_wins == 3 || $joueur2_wins == 3) {
        ...
        $check_existing_query = $conn->prepare("SELECT id FROM score_t4_tours WHERE id_match = ? AND id_tournoi = ?");
        ...
        if ($exists) {
            ...
            if (!$update_scores_query->execute()) {
                ...
                header('Location: /bracketts/views_tour/T4_résultat.php');
                exit;
            }
