...
?>
    ...
    <main>
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($group_matches as $match): ?>
                        <tr onclick="window.location.href='score.php?id_match=<?php echo urlencode($match['id_match']); ?>'">
        ...
        <div class="button-group">
            <a href="eliminatoire.php" class="button">Retour au tableau éliminatoire</a>
        </div>
    </main>
