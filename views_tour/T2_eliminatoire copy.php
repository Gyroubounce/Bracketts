...
if (isset($_SESSION['tours_session2'])) {
    $tours = $_SESSION['tours_session2'];
} else {
    $tours = array();
...
<main>
    ...
    <?php if (!empty($groupes)): ?>
        <?php foreach ($groupes as $id_tournoi => $matches): ?>
            ...
            <h2 class="clickable-header" onclick="window.location.href='T2_match.php?id_tournoi=<?php echo htmlspecialchars($id_tournoi); ?>'">
