...
?>
    ...
    <main>
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($group_matches as $match): ?>
                        <tr onclick="window.location.href='T3_score.php?id_match=<?php echo urlencode($match['id_match']); ?>'">
        ...
        <div class="button-group">
            <a href="T3_eliminatoire.php" class="button">Retour au tableau éliminatoire</a>
        </div>
    </main>
