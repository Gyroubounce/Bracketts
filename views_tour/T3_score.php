...
$scores_sql = "SELECT * FROM score_t3_tours WHERE id_match = ?";
...
<style>
    ...
    <main>
        <h1>Tour 3 Groupe <?php echo htmlspecialchars($id_tournoi); ?></h1>
        ...
        <?php if (!empty($match_details)): ?>
            <div class="match-container">
                ...
                <form method="post" action="/bracketts/controllers/T3_Controller.php?id_tournoi=<?php echo urlencode($id_tournoi); ?>&id_match=<?php echo urlencode($id_match); ?>">
                    <table>
                        <thead>
                            <tr>
                                <th>Joueur</th>
        ...
        <a href="T3_eliminatoire.php">Retour au tableau éliminatoire</a>
    </main>
