...
if (isset($_SESSION['tours_impairs'])) {
    $tours = $_SESSION['tours_impairs'];
} else {
    $tours = array();
...
<main>
    ...
    <?php if (!empty($groupes)): ?>
        <?php foreach ($groupes as $id_tournoi => $matches): ?>
            ...
            <h2 class="clickable-header" onclick="window.location.href='match.php?id_tournoi=<?php echo htmlspecialchars($id_tournoi); ?>'">
